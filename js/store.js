$(function () {
    $.getJSON('data/store.json', function (data) {
        ...
        // function findCounty (countryName, value){
        //     let countries = filterdArr.country;
        //     console.log(countries);
        //     let listHTML = '';
        //       filterdCounty = countries.filter(item => item[countryName] == value);
            
  
        //     console.log(filterdCounty);
